...
class QPackage:
    ...
    def __init__(self, iface):
        ...
        self.dlg._repertoire_boutton.setText(self.tr("Destination folder"))
        self.dlg.label_2.setText(self.tr("Project name: "))
        self.dlg._copy.setText(self.tr("Copy the layers"))
        #
        # # Charger les couches pour définir crs_origin
        # self.dlg.chargerCouches()
        # print ('self.crs_origin : ' + self.crs_origin)
        #
        # # Utiliser self.dlg.crs_origin
